...
public class ErrorMessage {
    ...
    public static final String NOT_A_NUMBER_PRICE_ERROR_MESSAGE = "[ERROR] 상품 가격은 반드시 숫자여야 합니다.";
    public static final String NOT_A_NUMBER_STOCK_ERROR_MESSAGE = "[ERROR] 상품 수량은 반드시 숫자여야 합니다.";
